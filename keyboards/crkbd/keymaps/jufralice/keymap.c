...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|---------+---------+---------+---------+------+--------+----------|  |---------+---------+---------+-----------+-----------+------------+------------|
       CKC_ESC,    CKC_A,    CKC_S,    CKC_D, CKC_F,    KC_G, DF(LGAME),     XXXXXXX,     KC_H,    CKC_J,      CKC_K,      CKC_L,    CKC_UNDS,        QUOT,
  //|---------+---------+---------+---------+------+--------+----------'  `---------+---------+---------+-----------+-----------+------------+------------|
        KC_GRV,     KC_Z,     KC_X,     KC_C,  KC_V,    KC_B,                             KC_N,     KC_M,        COM,        DOT,        COLN,     KC_PGDN,
  //|---------+---------+---------+---------+------+--------+----------.  ,---------+---------+---------+-----------+-----------+------------+------------|
  ...
  [LGRAPHITE] = LAYOUT_split_3x6_3_ex2(
  //,------------------------------------------------------------------.  -------------------------------------------------------------------------------.
        KC_DEL,     KC_B,     KC_L,     KC_D,  KC_W,    KC_Z, DF(LBASE),     XXXXXXX,     QUOT,     KC_F,       KC_O,       KC_U,        KC_J,     KC_PGUP,
  //|---------+---------+---------+---------+------+--------+----------|  |---------+---------+---------+-----------+-----------+------------+------------|
       CKC_ESC,     KC_N,     KC_R,     KC_T,  KC_S,    KC_G, DF(LGAME),     XXXXXXX,     KC_Y,     KC_H,       KC_A,       KC_E,        KC_I,        QUOT,
  //|---------+---------+---------+---------+------+--------+----------'  `---------+---------+---------+-----------+-----------+------------+------------|
        KC_GRV,     KC_Q,     KC_X,     KC_M,  KC_C,    KC_V,                             KC_K,     KC_P,        DOT,        COM,        COLN,     KC_PGDN,
  //|---------+---------+---------+---------+------+--------+----------.  ,---------+---------+---------+-----------+-----------+------------+------------|
                                          MO(LPART), CKC_TAB, CKC_ENTER,   CKC_SPACE,  KC_BSPC, XXXXXXX
                                         //`---------------------------'  `----------------------------'
  ),
  ...
  //,------------------------------------------------------------------.  ,-----------------------------------------------------------------.
      XXXXXXX, XXXXXXX, MS_WHLR, MS_WHLU, MS_WHLD,   MS_WHLL,   XXXXXXX,    XXXXXXX, XXXXXXX, DF(LMOUSE),   MS_UP, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+----------+----------|  |--------+--------+-----------+--------+--------+--------+--------|
       KC_ESC, KC_LSFT, MS_ACL0, MS_ACL1, MS_ACL2,   XXXXXXX,   XXXXXXX,    XXXXXXX, XXXXXXX,    MS_LEFT, MS_DOWN, MS_RGHT, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+----------+----------'  `--------+--------+-----------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI,   XXXXXXX,                        XXXXXXX,    MS_ACL0, MS_ACL1, MS_ACL2, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+----------+----------.  ,--------+--------+-----------+--------+--------+--------+--------|
                                        MO(LPART), DF(LBASE), CKC_ENTER,    MS_BTN1, MS_BTN2,    MS_BTN3
                                      //`------------------------------'  `-----------------------------'
  ),
  ...
  //,------------------------------------------------------------------------------------.  ,----------------------------------------------------------------------------.
         XXXXXXX,  XXXXXXX, XXXXXXX, MO(LVIMGIT),     XXXXXXX,     XXXXXXX, DF(LGRAPHITE),      XXXXXXX,        YC, DF(LVIMMOV),   XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX,
  //|-----------+---------+--------+------------+------------+------------+-------------|  |----------+----------+------------+----------+------------+--------+--------|
